...
public: 
  ...
  esp_err_t init(); 
  esp_err_t init(uint32_t init_sector); 
  ...
  esp_err_t read_unsafe(Frame *dst, size_t max_frames, size_t *frames_read, uint32_t read_addr_from, uint32_t *read_addr_new) const; 
  bool is_full() const;
